...
This is an implementation of CopyNet(another implementation of CopyNet can be viewed at https://github.com/allenai/allennlp-models/blob/master/allennlp_models/generation/models/copynet_seq2seq.py)
